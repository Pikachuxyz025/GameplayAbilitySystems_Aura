...
void USpellMenuWidgetController::SpendPointButonPressed()
{
	if (GetAuraASC())
	{
...
void USpellMenuWidgetController::EquipButtonPressed()
{
	...
	bWaitingForEquipSelection = true; // <- We're waiting at this point

	// We'll save our selected slot if it's an equipped ability
...
void USpellMenuWidgetController::SpellRowGlobePressed(const FGameplayTag& SlotTag, const FGameplayTag& AbilityType)
{
	...
	const FGameplayTag& SelectedAblityType = AbilityInfo->FindAbilityInfoForTag(SelectedAbility.Ability).AbilityType;
	if (!SelectedAblityType.MatchesTagExact(AbilityType))	return;
...
void USpellMenuWidgetController::OnAbilityEquipped(const FGameplayTag& AbilityTag, const FGameplayTag& Status, const FGameplayTag& Slot, const FGameplayTag& PreviousSlot)
{
	...
	SpellGlobeReassignedDelagate.Broadcast(AbilityTag);
	GlobeDeselect();
}
